...
ActiveRecord::Schema.define(version: 2023_05_10_164413) do
  ...
  create_table "college_applications_students", id: false, force: :cascade do |t|
    t.bigint "college_application_id", null: false
