        ...
        class AcceptedOffersController < Api::ApplicationController
            ...
            def create
                ...
                if params[:approval_type]=='individual_applications'
                    @individual_application=IndividualApplication.find_by(id: params[:approval_id])
                    @accepted_offer.approval=@individual_application
                elsif params[:approval_type]='college_applications'
                    @college_application=CollegeApplication.find_by(id: params[:approval_id])
                ...
                if @accepted_offer.save
                    ...
                    if @accepted_offer.errors.any?
                        render json: @accepted_offer.errors , status: 400 
                    else
            ...
            def calendar
                ...
                @accepted_colleges=AcceptedOffer.where(approval_type: 'CollegeApplication').and(AcceptedOffer.where(approval_id: @college_applications))
                    ...
                    if ch1==0 && ch2==0
                        ...
                        render json: { individuals: @accepted_individuals, colleges: @accepted_colleges }
                    end
                elsif current_user.role=='individual'
