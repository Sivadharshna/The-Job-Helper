Rails.application.routes.draw do
      ...
      namespace :api ,default: {format: :json} do
        ...
        get 'companies/:company_id/students/view', to: 'students#index'
        get '/companies/:company_id/students' , to: 'students#select'
        post '/companies/:company_id/students/:student_id/select_students', to: 'colleges#select_students'
